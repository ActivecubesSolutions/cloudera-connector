...
public abstract class HiveBaseResultSet implements ResultSet {
  ...
  public String getNString(String columnLabel) throws SQLException {
      ...
      StringBuilder colout = new StringBuilder(100);
      for (int i = 1; i <= columnNames.size() ; i++) {
          if(columnNames.size() == 1)
          {
              ...
              colout.append("{");
              colout.append("\"");
              colout = colout.append(columnNames.get(i-1));
              colout = colout.append("\"");
              colout = colout.append(":");
              colout = colout.append("\"");
             
              colout = colout.append(columnTypes.get(1-1));
              colout = colout.append("\"");
              colout.append("}");
          ...
          //columndetails.put(columnNames.get(i-1), columnTypes.get(i-1));
         
         
    }
      if(columnNames.size()!=1)
         {
         colout.deleteCharAt(colout.lastIndexOf(","));
         }
